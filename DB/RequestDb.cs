...
namespace DB
{
    public class RequestDb
    {
        ...
        public async Task SetQuestionAsync(string path, string name, int number)
        {
            ...
            _connectDb.GetCmd().Parameters.Add("@Name", SqlDbType.NVarChar, 500);
            _connectDb.GetCmd().Parameters.Add("@Number", SqlDbType.Int);
            await _connectDb.ConnectionOpenAsynk();
            ...
            using (FileStream fs = new FileStream(path, FileMode.Open))
            {
                ...
                _connectDb.GetCmd().Parameters.Add("@Image", SqlDbType.Image, Convert.ToInt32(fs.Length));
            }
